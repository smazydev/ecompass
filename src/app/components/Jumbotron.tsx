...
const Jumbotron = () => {
  return (
    ...
    <div className="h-screen flex justify-center p-20 bg-custom-grey rounded-br-[100px] rounded-bl-[100px]">
      <div className='w-1/2'>
        <h1 className="text-8xl uppercase font-bold">sharing <span className="inline-block"><Image width={100} height={30}src={Icon} alt={'loudspeaker'}/></span> <br />your vision</h1>
      </div>
      <div className="">
